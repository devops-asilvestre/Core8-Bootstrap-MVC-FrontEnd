    ...
    function reduceEventDrag(currentDrag, action) {
        ...
        switch (action.type) {
            ...
            case 'SET_EVENT_DRAG':
                ...
                return {
                    affectedEvents: newDrag.affectedEvents, mutatedEvents: newDrag.mutatedEvents, isEvent: newDrag.isEvent,
                };
            default:
                return currentDrag;
        }
    ...
    function reduceEventResize(currentResize, action) {
        ...
        switch (action.type) {
            ...
            case 'SET_EVENT_RESIZE':
                ...
                return {
                    affectedEvents: newResize.affectedEvents, mutatedEvents: newResize.mutatedEvents, isEvent: newResize.isEvent,
                };
            default:
    ...
    ***************************************************************************** */
    ...
    var ElementMirror = (function () {
        ...
        ElementMirror.prototype.doRevertAnimation = function (callback, revertDuration) {
            ...
            mirrorEl.style.transition = 'top ' + revertDuration + 'ms,' +
            ...
            for (var id in droppableStore) {
                ...
                if (offsetTracker && offsetTracker.isWithinClipping(offsetLeft, offsetTop)) {
                    ...
                    if (positionLeft >= 0 && positionLeft < width && positionTop >= 0 && positionTop < height) {
                        ...
                        if (hit && (common.rangeContainsRange(hit.dateProfile.activeRange, hit.dateSpan.range)) && (!bestHit || hit.layer > bestHit.layer)) {
                            hit.componentId = id;
    ...
    var EventDragging = (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                var isValid = component.isValidSegDownEl(origTarget) && !common.elementClosest(origTarget, '.fc-event-resizer');
    ...
    var UnselectAuto = (function () {
        function UnselectAuto(context) {
            ...
            this.onDocumentPointerDown = function (pev) {
                ...
                _this.matchesEvent = !!common.elementClosest(downEl, EventDragging.SELECTOR);
            };
...
var Setting_Calendar = function () {
    "use strict";
    return {
        init: function () {
            alert('Setting_Calendar: Start');
            handleCalendarDemo();
            alert('Setting_Calendar: Sucess');
        }
    };
}();